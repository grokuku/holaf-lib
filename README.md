...
version** (ex. `modal 0.1.0`). Quand un projet prend une brique, il en reçoit
...
```json
{
  "name": "holaf-lib",
  "bricks": {
    "modal": { "version": "0.1.0", "file": "js/holaf-modal.js" }
  }
}
```
...
|------------|---------------------|---------|------------|-------------------------------------------------------------------|
| modal      | `js/holaf-modal.js` | 0.1.0   | ✅ prête   | Modales, alertes, confirmations, saisies, écrans d'attente (busy) |
